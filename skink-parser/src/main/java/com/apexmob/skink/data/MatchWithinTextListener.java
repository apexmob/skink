...
public class MatchWithinTextListener extends ReadTextListener {
	
	private static final Logger logger = LoggerFactory.getLogger(MatchWithinTextListener.class);
	
	private final Pattern pattern;
	private final int groupIndex;

	public MatchWithinTextListener(DataManager manager, int fieldId, Pattern pattern, int groupIndex) {
